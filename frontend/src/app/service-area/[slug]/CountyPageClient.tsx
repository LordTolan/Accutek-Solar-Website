...
import { ArrowRight, MapPin, Phone, ShieldCheck, Zap, LandPlot, User } from "lucide-react";
import { CountyData } from "@/lib/counties-data";

const COUNTY_IMG = "https://images.unsplash.com/photo-1621431735623-95fcba6b89ae?crop=entropy&cs=srgb&fm=jpg&q=85&w=2000";

export default function CountyPageClient({ initialData }: { initialData: CountyData }) {
  const c = initialData;
          ...
          <div className="flex flex-col md:flex-row gap-12">
            <div className="flex-1 space-y-8">
              ...
              <div className="grid gap-6">
                {[
                  { title: "Local, Family-Owned", body: "Serving West Central Indiana and East Central Illinois families since 1994. No 1-800 numbers." },
