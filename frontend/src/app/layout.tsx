...
export const metadata: Metadata = {
  ...
  title: {
    default: "Accutek Solar - The Future of Energy | Solar Installer West Central Indiana & East Central Illinois.",
    template: "%s | Accutek Solar",
  },
  description: "Family-owned solar installer serving West Central Indiana & East Central Illinois since 1994. Solar PV, ground-mount arrays, Kohler generators, electrical. Free estimates - (812) 878-7343.",
  keywords: ["Accutek Solar", "solar installer West Central Indiana", "solar East Central Illinois", "ground-mount solar", "Kohler generator installer", "Clinton IN solar", "Terre Haute solar"],
  authors: [{ name: "Accutek Solar" }],
  openGraph: {
    type: "website",
    title: "Accutek Solar - The Future of Energy",
    description: "Family-owned solar & electrical contractor, 32 years strong. West Central Indiana & East Central Illinois.",
